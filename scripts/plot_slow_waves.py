#!/usr/bin/env python3
"""
Plot slow wave detection results.

Plots amplitude and duration comparisons (continuous vs adaptive) for State0 and State1.
Separate plots for TD_key2, TD_key3, and their average.
"""
...
from processing_SW.plot_slow_wave_results import (
    load_plot_config,
...
if __name__ == "__main__":
    ...
    import processing_SW.plot_slow_wave_results as plot_module
